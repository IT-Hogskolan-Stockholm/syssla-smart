...
<template>
  <div>
    <section class="create-new-section d-flex justify-center flex-column align-center">
      <v-btn @click="openAddRewardDialog" color="#f2ff3d"
          ...
          <v-form ref="form">
            <div class="container">
              ...
              <v-card-text class="flex-grow-0 " style="overflow: visible; padding-bottom: 0">
                ...
                <v-textarea variant="outlined" class="text" auto-grow style="height:160px" v-model="description"
                  placeholder="Beskrivning" rows="2"></v-textarea>
              </v-card-text>

              <v-card-text class="flex-grow-0 custom-card-text d-flex align-center">
                <div class="input-points">
                  <v-text-field variant="none" v-model="points" type="number" min="0" max="100" step="1"
                    class="mc-3 text-center text" style="max-width: 80px; text-align: center" label="Poäng" hide-details
              ...
              <v-card-text class="flex-grow-0" style="overflow: visible; padding-bottom: 0">
                <v-text-field variant="outlined" class="text"
                  placeholder="URL till bild (t.ex. Unsplash)"></v-text-field>
              </v-card-text>

              <!--Lägg till button section-->
              <v-card-actions class="justify-center flex-grow-0 mt-5">
                <v-btn color="green" @click="handleSubmit(rewardName)" size="large" class="add-btn" block>
